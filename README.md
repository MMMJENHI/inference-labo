...
**[https://mmmjenhi.github.io/inference-labo/]https://mmmjenhi.github.io/inference-labo/tree/main/labo1)
...
## Structure du Dépôt
- `index.html` : Dashboard central permettant de naviguer entre les laboratoires.
- `labo1/` à `labo15/` : Dossiers contenant les protocoles spécifiques à chaque recherche.

---
*Développé pour la recherche statistique et la simulation.*
